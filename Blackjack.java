...
public class Blackjack {
    ...
    public static void bajarse(List<String> manoJugador, String[][] manoDealer, String[] baraja){
        String[] ganador = verificarGanador(manoJugador, manoJugador).toArray(new String[0]);
    ...
    public static boolean esBlackjack(){
        List<String> mano = null;
